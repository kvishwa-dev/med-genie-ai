...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-[70px]
    bg-black/40 backdrop-blur-[20px]
    border-b border-[#3FB5F420]
    ...
    px-[5%] z-[100]">
      ...
      <Link
        href="/login"
        className="hidden md:flex w-[100px] h-[40px] rounded-[7px]
        bg-[#3FB5F4] hover:bg-[#2196d3]
        hover:shadow-[0_5px_15px_0_rgba(63,181,244,0.4)]
        transition-all duration-200
        justify-center items-center
        text-[18px] text-[#101010] font-medium"
      >
        Login
      </Link>
      ...
      <div
        ...
        py-4 px-[5%] flex flex-col gap-4 md:hidden 
      ...
      >
        ...
        <Link
          href="/login"
          onClick={() => setMenuOpen(false)}
          className="w-full h-[40px] rounded-[7px]
          bg-[#3FB5F4] hover:bg-[#2196d3]
          transition-all duration-200
          text-[18px] text-[#101010] font-medium
